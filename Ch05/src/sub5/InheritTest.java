 ...
 * -부모클래스의 속성 접근권한을 protected 로 변환하고 자식클래스에서는 부모 속성을 초기화
 */
...
class Child extends Parent{ //class 클래스명 extends 클래스명 -> 
...
public class InheritTest {
	...
	public static void main(String[] args) {
		...
		//상속 객체 생성, 상속시 heap 영역에서는 하나의객체로 생성
		...
		//Account 상속 객체 생성
		StockAccuont kb = new StockAccuont("KB증권","101-11-1020","홍길동",10000,"삼성전자",10,60000);
		kb.depsoit(1000000);
		kb.buy(5,58000);
		kb.sell(5,62000);
		kb.show();
